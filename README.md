...
- [3.1 תרשימים](#32-תרשימים)
- [3.2 החלטות אינטגרציה](#33-החלטות-אינטגרציה)
- [3.3 עדכון טבלאות לצורך אינטגרציה](#34-עדכון-טבלאות-לצורך-אינטגרציה)
- [3.4 יצירת views ו-שאילתות חדשות](#35-יצירת-views-ו-שאילתות-חדשות)
