...
- [2.1 שער שלב ב](#21-שער-שלב-ב)
- [2.2 שאילתות SELECT](#22-שאילתות-select)
- [2.3 שאילתות DELETE ו־UPDATE](#23-שאילתות-delete-ו-update)
- [2.4 אילוצים באמצעות ALTER TABLE](#24-אילוצים-באמצעות-alter-table)
- [2.5 טרנזקציות: COMMIT ו־ROLLBACK](#25-טרנזקציות-commit-ו-rollback)
