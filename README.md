...
- [3.1 הקדמה](#31-הקדמה)
- [3.2 תרשימים](#32-תרשימים)
- [3.3 החלטות אינטגרציה](#33-החלטות-אינטגרציה)
- [3.4 עדכון טבלאות לצורך אינטגרציה](#34-עדכון-טבלאות-לצורך-אינטגרציה)
- [3.5 יצירת views ו-שאילתות חדשות](#35-יצירת-views-ו-שאילתות-חדשות)
