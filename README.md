...
- [3.1 קבלת אגף חדש](#31-קבלת-אגף-חדש)
- [3.2 תרשימי ERD וDSD חדשים](#32-תרשימי-erd-וידsd-חדשים)
- [3.3 תרשימי ERD וDSD משותפים](#33-תרשימי-erd-וידsd-משותפים)
- [1.3 עדכון הטבלאות](#13-עדכון-הטבלאות)
- [1.4 יצירת views ו-שאילתות חדשות](#14-יצירת-views-ו-שאילתות-חדשות)
...
#### 3.2.1 תרשים DSD שהתקבל לאחר ניתוח הגיבוי.
![NEW DSA](שלב%20ג/newDepartmentDsd.png)


#### 3.2.2 סכמת ERD שהתקבלה לאחר הינדוס לאחור.
![NEW ERD](שלב%20ג/newDepartmentErd.png)


#### 3.2.3 סכמת ERD משולבת.
![ERD](שלב%20ג/newErd.png)

#### 3.2.4 תרשים DSD משולב.
![DSA](שלב%20ג/newDsd.png)


## 3.3 החלטות אינטגרציה
...
...
## 3.4 עדכון טבלאות לצורך אינטגרציה
...
### שלב 4 – תכנות
בשלב הזה נעבוד על כתיבת תוכניות PL/pgSQL על טבלאות בסיס הנתונים המורחב שלנו
## 4.1 פונקציות
