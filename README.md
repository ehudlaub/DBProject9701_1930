...
- [3.1 קבלת אגף חדש](#31-אגף-חדש)
- [3.2 תרשימי ERD וDSD חדשים](#32-תרשימי-new-erd-וdsd)
- [3.3 תרשימי ERD וDSD משותפים](#33-תרשימי-both-erd-וdsd)
- [1.3 עדכון הטבלאות](#13-החלטות-עיצוב)
- [1.4 יצירת שאילתות חדשות](#14-שיטות-אכלוס-הנתונים)
...
נוסיף עמודות חדשות לטבלאות של Activity ו-RESIDENT
###  עדכון טבלת  Activity
הוספנו עמודה של מיקום הפעילות על פי רשימה של מיקומים קומה של הפעילות, חצר או גג
![newActvity](שלב%20ג/addToActvity.png) 
###  עדכון טבלת  Resident 
הוספת עמודה resudent_dob
![newResident](שלב%20ג/addToResident.png) 
## 1.4 יצירת שאילתות חדשות
נרצה לעשות שאילתות חדשות על בסיס הוספת העמודות החדשות.
למשל הצג את שמות הדיירים, תעודות הזהות שלהם, שמות הפעילויות שהם משתתפים בהן, והמיקומים של אותן פעילויות (location), רק אם המיקום הוא Roof או Floor 2, ממויין לפי location.
בשאילת זו הפלט הוא 50 שורות

![activityQurey](שלב%20ג/activityQurey.png) 
