...
## 3.1 קבלת אגף חדש
בשלב זה קיבלנו אגף חדש של דיירים וחדרים ונרצה לבצע אינטגרציה אם האגף של פעיליות על ידי ביצוע הינדוס לאחור של האגף החדש ובנית בסכמה חדשה שמשתפת בין שניי האגפים.
---
##  3.2 תרשימי ERD וDSD חדשים
...
##  3.3 תרשימי ERD וDSD משותפים


### ERD – תרשים ישויות וקשרים המשותף:
![ERD](שלב%20ג/newErd.png)



### DSD – תרשים סכמת הנתונים המשותף:
...
פרוצדורה 2
מאתרת אנשי צוות שאין להם תפקיד (job_title IS NULL) ומוחקת אותם מהמערכת. משתמשת בלולאה, CURSOR, תנאים, חריגה ו־DELETE.
