...
- [5.1 הוראות הפעלה](#51-הוראות-הפעלה)
- [5.2 מסכים במערכת](#52-מסכים-במערכת)
  - [5.2.1 מסך כניסה](#521-מסך-כניסה)
- [5.3 מסך מנהל](#53-מסך-מנהל)
  - [5.3.1 ניהול פעילויות](#531-ניהול-פעילויות)
  - [5.3.2 רישום והסרת דיירים](#532-רישום-והסרת-דיירים)
  - [5.3.3 תשלומים לספקים](#533-תשלומים-לספקים)
  - [5.3.4 דוחות](#534-דוחות)
- [5.4 מסך דייר](#54-מסך-דייר)
- 
...
בשלב זה פותח ממשק גרפי לניהול פעילויות בבית האבות. הממשק נכתב בשפת Python באמצעות Tkinter, ומאפשר אינטראקציה ישירה עם בסיס הנתונים PostgreSQL.

---

## 5.1 הוראות הפעלה

1. ודאו כי מסד הנתונים פועל ומכיל את כל הסכמות, הטבלאות, הפונקציות והפרוצדורות מהשלבים הקודמים.
2. הפעילו את הקובץ `login_screen.py` מתוך תיקיית `gui`.
3. במסך הכניסה ניתן לבחור בין כניסה כמנהל לבין כניסה כדייר, בהתאם למזהה רלוונטי.
...
- מאפשר לבחור כניסה כמנהל או להזין מזהה דייר.
- מעביר למסך המתאים בהתאם לסוג המשתמש.

![login](שלב%20ה/screens/login.png)
...
![add_activity](שלב%20ה/screens/add_activity.png)

#### עדכון פעילות

![update_activity](שלב%20ה/screens/update_activity.png)
...
- מציג את הנתונים שנרשמו ליומן התשלומים לאחר ביצוע תשלום.

![paid_supplies](שלב%20ה/screens/paid_supplies.png)
...
- מאפשר רישום לפעילות, הסרה, והשארת פידבק.

![resident_dashboard](שלב%20ה/screens/resident_dashboard.png)
...
- הצגת פעילויות שהדייר רשום אליהן.
- הסרה דרך לחצן מתאים.

![remove_activity](שלב%20ה/screens/remove_activity.png)

---

### 5.4.4 השארת פידבק

- תצוגת טבלה עם כלל הפעילויות שהדייר השתתף בהן.
- אפשרות סינון לפי מזהה פעילות או מזהה מדריך.
- הזנת דירוג בין 1 ל־5 ותגובה חופשית.

![leave_feedback](שלב%20ה/screens/leave_feedback.png)
